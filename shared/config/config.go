...
func Load() (*Config, error) {
	...
	// Explicitly bind every env var — required for AutomaticEnv + Unmarshal to work reliably
	for _, key := range []string{
		"APP_ENV", "LOG_LEVEL", "BASE_URL",
		"DATABASE_URL", "REDIS_URL", "CLICKHOUSE_URL", "CLICKHOUSE_DB",
		"VAULT_ADDR", "VAULT_TOKEN",
		"X_CONSUMER_KEY", "X_CONSUMER_SECRET",
		"X_ACCESS_TOKEN", "X_ACCESS_SECRET",
		"X_BEARER_TOKEN", "X_WEBHOOK_ENV", "X_WEBHOOK_SECRET",
		"BOT_TWITTER_ID", "BOT_TWITTER_HANDLE",
		"SAFEHAVEN_BASE_URL", "SAFEHAVEN_CLIENT_ID", "SAFEHAVEN_CLIENT_SECRET",
		"SAFEHAVEN_PRIVATE_KEY_PATH", "SAFEHAVEN_PRIVATE_KEY_PEM",
		"FLUTTERWAVE_SECRET_KEY", "FLUTTERWAVE_HASH_SECRET",
		"PAYSTACK_SECRET_KEY", "PAYSTACK_WEBHOOK_SECRET",
		"STRIPE_SECRET_KEY", "STRIPE_WEBHOOK_SECRET", "STRIPE_PLATFORM_ACCOUNT_ID",
		"CRYPTO_RPC_URL", "CRYPTO_CHAIN_ID", "CRYPTO_TREASURY_VAULT_PATH",
		"ADMIN_JWT_SECRET", "ADMIN_DUAL_APPROVAL_THRESHOLD_NGN", "ADMIN_DUAL_APPROVAL_THRESHOLD_USD",
		"GRPC_XGATEWAY_ADDR", "GRPC_GIVEAWAY_ADDR", "GRPC_ENTRY_ADDR",
		"GRPC_PAYMENT_ROUTER_ADDR", "GRPC_KYC_ADDR", "GRPC_COMPLIANCE_ADDR",
		"GRPC_AUDIT_ADDR", "GRPC_NOTIFICATION_ADDR", "GRPC_RECONCILIATION_ADDR",
		"PAGERDUTY_ROUTING_KEY", "SLACK_WEBHOOK_URL",
		"RATE_LIMIT_WEBHOOK_RPS", "RATE_LIMIT_API_RPS", "MAX_ACTIVE_GIVEAWAYS_PER_HOST",
	} {
		_ = viper.BindEnv(key)
	}
